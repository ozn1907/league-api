...
<div class="container mx-auto mt-5">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md mb-4">
            {{-- <img src="{{ $dataDragonBaseUrl }}/cdn/{{ $version }}/img/champion/{{ $champion['image']['full'] }}"
                alt="{{ $champion['name'] }} Image" class="w-full h-32 object-cover"> --}}
            <div class="p-4">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md mb-4 p-4">
            <p class="font-semibold mb-2 text-red-500">Champion with ID {{ $championId }} not found in champion data.
            </p>
        </div>
        @endif
        @endforeach
