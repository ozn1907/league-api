                    ...
                    <div
                        ...
                        <div>
                            ...
                            <ul class="pl-4 mt-4 text-gray-700 dark:text-gray-300 text-base leading-relaxed list-disc">
                                <li class="text-gray-500">Clone the repository</li>
                                <li class="text-gray-500">Configure your Riot API key and region</li>
                                <li class="text-gray-500">Dive into the Summoner details, champion rotations, and more!
                                </li>
                            </ul>
