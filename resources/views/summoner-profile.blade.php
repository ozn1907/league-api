...
<div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
    <div class="max-w-5xl w-full p-6 bg-white dark:bg-gray-800 rounded-md shadow-md">
        ...
        <form action="{{ route('favorites') }}" method="post" class="mb-6 text-center">
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center">
                    <img src="{{ $dataDragonService->getProfileIconUrl($summonerInfo['profileIconId']) }}" alt="Profile Icon" class="w-32 h-32 rounded-full shadow-md border-4">
                    <div class="ml-4">
        ...
        @endif
        {{-- Display match IDs if available --}}
        @if(isset($matchIds))
        <div class="mb-6 text-center">
            <h2 class="text-2xl font-semibold mb-4 text-gray-800">Match IDs</h2>
            <ul>
                @forelse($matchIds as $matchId)
                <li>{{ $matchId }}</li>
                @empty
                <p>No match IDs found.</p>
                @endforelse
            </ul>
        </div>
        @endif
        ...
        <div class="mb-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="relative" data-champion-id="{{ optional($mastery)['championId'] }}">
                    <div class="bg-white dark:bg-gray-800 border border-gray-300 p-6 rounded-md hover:border-indigo-500 hover:shadow-lg hover:transform hover:scale-105 transition duration-300">
                        <img src="{{ $dataDragonService->getChampionIconUrl(optional($mastery)['championId']) }}" alt="Champion Icon" class="w-20 h-20 mx-auto mb-4 rounded-full">
                        ...
                        <p class="text-gray-600 flex justify-center items-center">
                            ...
                            <img class="h-4 w-4 inline-block ml-1" src="{{ asset('svg/mastery_crown.svg') }}" alt="Mastery Crown Icon">
                        </p>
