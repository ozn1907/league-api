...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-2xl w-full p-6 bg-white dark:bg-gray-800 rounded-md shadow-md">
        ...
        @if(isset($summonerInfo) && isset($summonerInfo['profileIconId']) && isset($summonerInfo['name']) &&
        isset($summonerInfo['summonerLevel']))
        <h1 class="text-4xl font-extrabold mb-6 text-center text-indigo-600">Summoner Profile</h1>
        <div class="mb-8 text-center">
            <img src="{{ $dataDragonService->getProfileIconUrl($summonerInfo['profileIconId']) }}" alt="Profile Icon"
                class="inline-block rounded-full shadow-md border-4 border-indigo-300 p-2">
        </div>
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="m-4 p-4 border border-gray-300 rounded-md bg-indigo-100 text-indigo-800">
                    <img src="{{ $dataDragonService->getChampionIconUrl(optional($mastery)['championId']) }}"
                        alt="Champion Icon" class="w-16 h-16 mb-4 mx-auto rounded-full">
